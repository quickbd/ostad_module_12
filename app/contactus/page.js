...
export default async function contactus(param) {
  return (
    <div className="container   m-auto my-40 items-center justify-between">
      <h1 className="text-center mt-30">Contact Us</h1>
          ...
          <div className="flex text-justify">
            <div className="block max-w-md rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
              <form>
                ...
                <button
                  type="submit"
                  className="dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]] 
                  inline-block w-full rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal
